...
import { clientTypeSchema, ClientTypeInput } from "@/schemas/settings"
...
export function ClientTypeModal({ open, onOpenChange, type }: ClientTypeModalProps) {
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <DialogHeader className="p-8 bg-blue-600 text-white">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mt-1">Configurar perfil e multiplicador</p>
                            </div>
                        </div>
                    </DialogHeader>
                    ...
                    <div className="p-8 flex flex-col gap-6 bg-white dark:bg-neutral-950">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Nome do Tipo</Label>
                            <Input 
                                {...register("name")}
                        ...
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Multiplicador de Preço</Label>
                            <Input 
                                {...register("multiplier")}
                                type="number" 
                                step="0.01" 
                            ...
                            <p className="text-[9px] font-bold text-neutral-400 uppercase">Use 1.00 para preço base. Ex: 1.25 adiciona 25% ao valor.</p>
                        </div>

                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Descrição Interna</Label>
                            <Textarea 
