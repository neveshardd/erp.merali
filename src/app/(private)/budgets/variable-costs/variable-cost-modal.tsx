...
import { type VariableCostInput, variableCostSchema } from "@/schemas/costs";
...
export function VariableCostModal({
  open,
  onOpenChange,
  cost,
}: VariableCostModalProps) {
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mt-1">
                  Vincule despesas a projetos específicos
                </p>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="p-8 flex flex-col gap-6 bg-white dark:bg-neutral-950">
            <div className="space-y-3">
              ...
              <Select
                onValueChange={(value) =>
                  reset({ budgetId: value === "none" ? null : value })
                }
