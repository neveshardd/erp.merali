...
export function PricingRatesModal({
  open,
  onOpenChange,
  budgetId,
}: RatesModalProps) {
  ...
  const {
    data: operational = { total: 0, fixed: 0, variable: 0 },
  ...
  const calculatedHourlyRate =
    baseHours > 0 ? operational.total / baseHours : 0;
  const effectiveHourlyRate =
    hourlyRate > 0 ? hourlyRate : calculatedHourlyRate;
          ...
          <div className="p-6 overflow-y-auto flex-1 flex flex-col gap-5 custom-scrollbar">
            ...
            <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-xl border border-neutral-100 dark:border-neutral-800 flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-black text-neutral-900 dark:text-white uppercase">
                  {formatCurrency(operational.total)}
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  value={baseHours}
                  onChange={(e) =>
                    setBaseHours(parseFloat(e.target.value) || 0)
                  }
            ...
            <div className="p-4 bg-neutral-900 dark:bg-white rounded-xl flex flex-col items-center gap-1 shadow-inner">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-2xl font-black text-white dark:text-neutral-900 tabular-nums">
                  {formatCurrency(
                    effectiveHourlyRate * multiplier * (1 + profitMargin / 100),
                  )}
                </span>
                <span className="text-[10px] font-bold text-white/40 dark:text-neutral-900/40 uppercase">
                  /hora
                </span>
              </div>
            </div>
