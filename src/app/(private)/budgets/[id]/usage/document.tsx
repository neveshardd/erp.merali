            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <View>
                        ...
                        <Text style={styles.subtitle}>Cessão de Direitos para Portfólio e Marketing</Text>
                    </View>
                ...
                <View wrap={false} style={styles.consentBox}>
                    ...
                    <Text style={styles.consentText}>
                        Pelo presente instrumento, eu <Text style={styles.bold}>{data.client.name}</Text>, devidamente qualificado como proprietário ou representante legal do cliente <Text style={styles.bold}>{data.client.company}</Text>, autorizo de forma gratuita e sem restrições territoriais ou temporais o <Text style={styles.bold}>MERALI STUDIO DE VISUALIZAÇÃO</Text> a utilizar as imagens produzidas para o projeto <Text style={styles.bold}>"{data.project}"</Text> para fins de divulgação de seu trabalho artístico e técnico.
                    </Text>
                </View>
                ...
                <View style={styles.signatures}>
                    <View style={styles.signatureBlock}>
                        ...
                        <Text style={styles.signatureRole}>Detentor dos Direitos Autorais</Text>
                    </View>
                    <View style={styles.signatureBlock}>
                        <View style={styles.signatureLine} />
                ...
                <View style={styles.footer}>
                    <View style={styles.protocol}>
                        ...
                        <Text style={styles.footerText}>Autorização de Marketing Merali Studio</Text>
                    </View>
