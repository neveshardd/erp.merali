...
import { DollarSign, Save, Calendar, Loader2 } from "lucide-react"
import { useForm } from "react-hook-form"
import { zodResolver } from "@hookform/resolvers/zod"
import { fixedCostSchema, FixedCostInput } from "@/schemas/costs"
...
export function FixedCostModal({ open, onOpenChange, cost }: FixedCostModalProps) {
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <DialogHeader className="p-8 bg-neutral-900 text-white">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mt-1">Custos recorrentes da estrutura</p>
                            </div>
                        </div>
                    </DialogHeader>
                    ...
                    <div className="p-8 flex flex-col gap-6 bg-white dark:bg-neutral-950">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Descrição do Custo</Label>
                            <Input 
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-3">
                                <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Categoria</Label>
                                <Input 
                                    {...register("category")}
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Valor Mensal</Label>
                                <Input 
                                    {...register("value")}
                                    type="number" 
                                    step="0.01"
                        ...
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Dia de Vencimento</Label>
                            <div className="relative">
                                ...
                                />
                                {errors.dueDate && (
                                    <p className="text-red-500 text-[10px] uppercase font-bold">{errors.dueDate.message}</p>
                                )}
                            </div>
                        </div>
                    </div>
