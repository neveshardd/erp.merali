  ...
  return (
    <main className="flex flex-col gap-6 p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 uppercase tracking-tighter">
            Gerenciar Orçamentos
          </h1>
          <p className="text-neutral-500 text-sm font-bold uppercase tracking-widest text-[9px]">
            Visualize e gerencie todos os seus orçamentos em um só lugar.
          </p>
        </div>
        <Button
          onClick={() => {
        ...
        <Table>
          <TableHeader className="bg-neutral-50/50 dark:bg-neutral-800/50 border-b border-neutral-200 dark:border-neutral-800">
            <TableRow className="hover:bg-transparent">
              <TableHead className="font-black text-neutral-900 dark:text-neutral-100 py-4 uppercase tracking-widest text-[10px]">
                Projeto
              </TableHead>
              <TableHead className="font-black text-neutral-900 dark:text-neutral-100 uppercase tracking-widest text-[10px]">
                Cliente
              </TableHead>
              <TableHead className="font-black text-neutral-900 dark:text-neutral-100 uppercase tracking-widest text-[10px]">
                Prazo
              ...
              <TableHead className="text-right font-black text-neutral-900 dark:text-neutral-100 pr-6 uppercase tracking-widest text-[10px]">
                Ações
              </TableHead>
            </TableRow>
          </TableHeader>
            ...
            {isLoading ? (
              ...
              filteredBudgets.map((budget: any) => (
                ...
                >
                  <TableCell className="py-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="font-black text-neutral-900 dark:text-neutral-100 uppercase tracking-tight group-hover:text-neutral-900 dark:group-hover:text-white transition-colors">
                          {budget.projectName}
                        </span>
                  ...
                  <TableCell>
                    <div className="flex flex-col">
                      <span className="text-neutral-900 dark:text-neutral-100 font-black text-[11px] uppercase">
                        {budget.client?.name}
                      </span>
                      <span className="text-[10px] text-neutral-400 font-bold uppercase tracking-widest">
                        {budget.clientTypeName}
                      </span>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge
                      variant="outline"
                      className={cn(
                        "font-black px-2 py-0.5 border-neutral-200 dark:border-neutral-800 text-[9px] tracking-widest",
                  ...
                  >
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          className="h-8 w-8 p-0 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-full cursor-pointer"
                        >
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="w-56 border-neutral-200 dark:border-neutral-800 shadow-xl rounded-2xl p-2 bg-white dark:bg-neutral-950"
                      >
                        <DropdownMenuLabel className="text-[9px] uppercase font-black text-neutral-400 tracking-widest px-2 py-2">
                          Ações do Orçamento
                        </DropdownMenuLabel>
                        <DropdownMenuItem asChild>
                          ...
                          >
                            <Eye className="w-4 h-4 text-neutral-500" /> Ver
                            Detalhes e Itens
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          ...
                          className="gap-2 cursor-pointer font-bold text-[10px] uppercase p-3 rounded-xl hover:bg-neutral-50 dark:hover:bg-white/5 transition-all"
                        >
                          <Pencil className="w-4 h-4 text-neutral-500" /> Editar
                          Dados Básicos
                        </DropdownMenuItem>
                        <DropdownMenuItem className="gap-2 cursor-pointer font-bold text-[10px] uppercase p-3 rounded-xl hover:bg-neutral-50 dark:hover:bg-white/5 transition-all">
                          <Copy className="w-4 h-4 text-neutral-500" /> Duplicar
                          Orçamento
                        </DropdownMenuItem>
