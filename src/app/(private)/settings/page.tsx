...
export default function SettingsPage() {
  ...
  const [erpPortfolioConfig, setErpPortfolioConfig] =
    React.useState<ErpPortfolioConfigFields>({
  ...
  React.useEffect(() => {
    if (configGroups) {
      ...
      // Load ERP Portfolio
      const erpPortfolioGroup = configGroups.find(
  ...
  const handleSave = async () => {
    try {
      ...
      // Save ERP Portfolio
      const erpConfigs = Object.entries(erpPortfolioConfig).map(
        ([key, value]) => ({
          key,
          value:
            key === "textCards" ? JSON.stringify(value) : (value as string),
          label: key,
        }),
      );
    ...
    <main className="flex flex-col gap-8 p-8 max-w-6xl mx-auto pb-24">
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-2 border-b border-neutral-100 dark:border-neutral-800 pb-4">
          <h2 className="text-sm font-black uppercase tracking-tight text-neutral-900 dark:text-neutral-100">
            Geral
          </h2>
        </div>
      ...
      <section className="space-y-6 pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="space-y-2">
            <Label className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">
              Telefone de Contato (Para o PDF)
            </Label>
            <Input
          ...
          <div className="space-y-2">
            <Label className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">
              Instagram / Link Extra (Para o PDF)
            </Label>
            <Input
                ...
                <div key={index} className="flex gap-2 group">
                  ...
                  <div className="flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() => {
                        const newPhrases = erpPortfolioConfig.textCards.filter(
                          (_, i) => i !== index,
                        );
                        setErpPortfolioConfig({
                          ...erpPortfolioConfig,
