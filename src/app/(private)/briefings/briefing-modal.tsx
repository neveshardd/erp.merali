...
import { FileText, Link2, Send, UserPlus } from "lucide-react";
        ...
        <div className="p-8 flex flex-col gap-8 bg-white dark:bg-neutral-950">
          ...
          >
            <TabsList className="grid w-full grid-cols-2 h-12 bg-neutral-100 dark:bg-neutral-900 p-1 rounded-xl mb-6">
              <TabsTrigger
                value="technical"
                className="rounded-lg font-bold uppercase tracking-widest text-[10px] data-[state=active]:bg-white dark:data-[state=active]:bg-neutral-800 shadow-none"
              >
                Técnico (Projeto)
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="technical" className="flex flex-col gap-6 m-0">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/30">
                <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wide leading-relaxed">
                  Ao gerar um briefing técnico, um link exclusivo será criado e
                  vinculado automaticamente ao cronograma de produção deste
                  projeto.
                </p>
              </div>
            </TabsContent>
        ...
        <DialogFooter className="p-6 bg-neutral-50 dark:bg-neutral-900/50 border-t border-neutral-100 dark:border-neutral-800 flex flex-col sm:flex-row gap-3">
          ...
          >
            {isSubmitting ? (
              ...
              <>
                <Link2 className="w-4 h-4" /> Gerar Link Técnico
              </>
            ) : (
              <>
                <Send className="w-4 h-4" /> Criar Lead & Link
              </>
            )}
          </Button>
        </DialogFooter>
