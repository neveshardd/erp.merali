  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] p-0 overflow-hidden border-none shadow-2xl rounded-3xl">
        <DialogHeader
          className={`p-8 ${isTechnical ? "bg-blue-600" : "bg-purple-600"} text-white`}
        >
              ...
              <section className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(displayDetails.downloadLink, "_blank")
                    }
                  >
              ...
              <section className="flex flex-col gap-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 rounded-2xl flex flex-col gap-1">
                    ...
                    <span className="text-xs font-black lowercase text-purple-600">
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 rounded-2xl flex flex-col gap-1">
                    ...
                    <span className="text-xs font-black uppercase tabular-nums">
                      {displayDetails.whatsapp}
                    </span>
                  </div>
                </div>
                ...
                <Card className="border-none bg-purple-50 dark:bg-purple-900/10 rounded-3xl p-8">
                  <div className="flex flex-col gap-4">
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-purple-600">
                      Mensagem do Lead
                    </h4>
