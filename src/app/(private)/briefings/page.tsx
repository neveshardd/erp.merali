    ...
    <main className="flex flex-col gap-8 p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-500 text-sm font-bold uppercase tracking-widest mt-1">
            Acompanhe leads e especificações técnicas
          </p>
        </div>
      ...
      <Tabs defaultValue="technical" className="w-full">
        <TabsList className="bg-neutral-100 dark:bg-neutral-900 p-1 rounded-xl h-12 w-full md:w-auto mb-6">
          <TabsTrigger
            value="technical"
            className="rounded-lg font-bold uppercase tracking-widest text-[10px] data-[state=active]:bg-white dark:data-[state=active]:bg-neutral-800 data-[state=active]:shadow-sm px-6"
          >
            Briefings Técnicos
          </TabsTrigger>
          <TabsTrigger
