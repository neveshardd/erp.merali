      ...
      <Page size="A4" style={styles.page}>
        ...
        <View wrap={false} style={styles.statementBox}>
          ...
          <Text style={styles.statementText}>
            Eu, <Text style={styles.bold}>{data.client.name}</Text>,
            representante da empresa{" "}
            <Text style={styles.bold}>{data.client.company}</Text>, declaro para
            os devidos fins que recebi e aprovei todos os produtos e serviços
            listados neste documento, referentes ao projeto{" "}
            <Text style={styles.bold}>"{data.project}"</Text> executado pelo{" "}
            <Text style={styles.bold}>MERALI STUDIO</Text>.{"\n\n"}
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerText}>
            Merali ERP Document Engine | Pág 01/01
          </Text>
        </View>
      </Page>
    </Document>
