      ...
      <div className="max-w-[21cm] mx-auto bg-white shadow-2xl print:shadow-none min-h-[29.7cm] p-[2cm] flex flex-col gap-10 text-neutral-900 relative border-t-8 border-cyan-500">
        ...
        <header className="flex justify-between items-start">
          <div className="flex flex-col gap-4">
            ...
            />
            <div>
              <h1 className="text-2xl font-black uppercase tracking-tighter text-neutral-900">
                Aprovação Final
              </h1>
              <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest leading-none mt-1">
                Termo de Encerramento e Aceite de Projeto
              </p>
            </div>
          </div>
        ...
        <div className="bg-neutral-50 p-8 rounded-3xl border border-neutral-100 flex flex-col gap-4 text-left">
          ...
          <p className="text-sm font-medium leading-relaxed text-neutral-600 uppercase">
            Eu, <strong>{approval.client.name}</strong>, representante da
            empresa <strong>{approval.client.company}</strong>, declaro para os
            devidos fins que recebi e aprovei todos os produtos e serviços
            listados neste documento, referentes ao projeto{" "}
            <strong>"{approval.project}"</strong> executado pelo{" "}
            <strong>MERALI STUDIO</strong>.
            <br />
            <br />
            Confirmo que a entrega está em total conformidade com as
            especificações contratadas, dando por encerrada esta etapa de
            produção sem quaisquer pendências técnicas ou artísticas.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-[10px] font-black uppercase tracking-widest text-neutral-300 border-b border-neutral-100 pb-2">
            Itens Entregues e Conferidos
          </h2>
          <div className="grid grid-cols-1 gap-3">
            {approval.itemsDelivered.map((item: any, i: number) => (
              <div
                key={i}
                className="flex items-center justify-between p-4 bg-white border border-neutral-100 rounded-xl hover:bg-neutral-50 transition-colors"
              >
                <span className="text-xs font-bold uppercase text-neutral-900 tracking-tight">
                  {item.description}
                </span>
        ...
        <div className="mt-auto grid grid-cols-2 gap-20 py-12">
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-[9px] font-black uppercase text-neutral-900">
              Merali Studio de Visualização
            </span>
            <span className="text-[7px] text-neutral-400 uppercase font-bold tracking-widest">
              Responsável Técnico
            </span>
          </div>
