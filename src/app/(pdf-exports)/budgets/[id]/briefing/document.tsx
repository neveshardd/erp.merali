      ...
      <Page size="A4" style={styles.page}>
        ...
        <View wrap={false} style={styles.section}>
          ...
          <View style={styles.contentBlock}>
            ...
            {data.links && data.links.length > 0 ? (
              ...
              <Text
                style={[styles.contentText, { color: "#9CA3AF", fontSize: 8 }]}
              >
                NENHUM LINK ANEXADO
              </Text>
            )}
        ...
        <View wrap={false} style={styles.section}>
          ...
          <View style={styles.contentBlock}>
            ...
            <Text style={styles.contentText}>
              {data.lightingNotes ||
                "Nenhum detalhe de iluminação ou atmosfera fornecido."}
            </Text>
          </View>
        </View>
        ...
        <View wrap={false} style={styles.section}>
          ...
          <View style={styles.contentBlock}>
            <Text style={styles.contentText}>
              {data.materialsNotes ||
                "Nenhuma observação específica sobre materiais ou acabamentos."}
            </Text>
          </View>
        </View>

        <View style={[styles.section, { marginTop: 20 }]}>
          <Text style={[styles.infoLabel, { fontSize: 8, color: "#F43F5E" }]}>
            Status do Briefing: {data.status}
          </Text>
        </View>

        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Merali ERP Document Engine | Technical Unit
          </Text>
