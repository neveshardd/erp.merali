            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b-2 border-neutral-900">
                  <th className="py-3 text-[10px] font-black uppercase tracking-widest text-neutral-400">
                    Serviço
                  </th>
                  <th className="py-3 text-[10px] font-black uppercase tracking-widest text-neutral-400 text-center">
                    Qtd
                  </th>
                  <th className="py-3 text-[10px] font-black uppercase tracking-widest text-neutral-400 text-right">
                    Unitário
                  </th>
                  <th className="py-3 text-[10px] font-black uppercase tracking-widest text-neutral-900 text-right">
                    Total
                  </th>
                </tr>
              </thead>
              <tbody>
                {budget.items.map((item, _i) => (
                  <tr key={item.id} className="border-b border-neutral-100">
                    ...
                    <td className="py-4 text-xs font-bold text-neutral-500 text-center tabular-nums">
                      {item.quantity}
                    </td>
        ...
        {budget.variableCosts.length > 0 && (
          <div className="flex flex-col gap-4">
            ...
            <table className="w-full text-left">
              ...
              <tbody>
                {budget.variableCosts.map((item, _i) => (
                  <tr key={item.id} className="border-b border-neutral-100">
                    <td className="py-4">
                      <span className="text-sm font-black uppercase tracking-tight text-neutral-900">
                        {item.description}
                    ...
                    <td className="py-4 text-xs font-bold text-neutral-500 uppercase text-center tabular-nums">
                      {item.date}
                    </td>
                    <td className="py-4 text-sm font-black text-neutral-900 text-right tabular-nums">
            ...
            <div className="mt-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                {paymentSchedule.map((p, i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center text-[10px] font-bold uppercase bg-neutral-50 p-2 border border-neutral-100"
                  >
