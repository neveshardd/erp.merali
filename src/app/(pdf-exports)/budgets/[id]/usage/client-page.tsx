      ...
      <div className="max-w-[21cm] mx-auto bg-white dark:bg-neutral-900 shadow-2xl print:shadow-none min-h-[29.7cm] p-[2cm] flex flex-col gap-10 text-neutral-900 dark:text-neutral-100 relative border-t-8 border-purple-500">
        ...
        <div className="bg-purple-50/30 dark:bg-purple-900/10 p-8 rounded-3xl border border-purple-100 dark:border-purple-900/30 flex flex-col gap-6 text-justify relative overflow-hidden">
          ...
          <p className="text-sm font-medium leading-relaxed text-neutral-700 dark:text-neutral-300 relative z-10 uppercase">
            ...
            , devidamente qualificado como proprietário ou representante legal
            do cliente{" "}
            <strong className="text-neutral-900 dark:text-white">
              {usage.client.company}
            </strong>
            , autorizo de forma gratuita e sem restrições territoriais ou
            temporais o{" "}
            <strong className="text-neutral-900 dark:text-white">
              MERALI STUDIO DE VISUALIZAÇÃO
            </strong>{" "}
            a utilizar as imagens produzidas para o projeto{" "}
            <strong className="text-neutral-900 dark:text-white">
              "{usage.project}"
            </strong>{" "}
            para fins de divulgação de seu trabalho artístico e técnico.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 text-neutral-900 dark:text-neutral-100">
          ...
          <div className="grid grid-cols-2 gap-4">
            {usage.terms.map((term: string, i: number) => (
              <div
                key={i}
                className="flex items-start gap-4 p-4 bg-white dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800 rounded-xl hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
              >
                ...
                <span className="text-[11px] font-bold uppercase text-neutral-600 dark:text-neutral-400 leading-tight tracking-tight">
                  {term}
                </span>
              </div>
            ))}
        ...
        <div className="mt-auto grid grid-cols-2 gap-20 py-12">
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-[9px] font-black uppercase text-neutral-900 dark:text-neutral-100">
              Merali Studio de Visualização
            </span>
            <span className="text-[7px] text-neutral-400 uppercase font-bold text-center tracking-widest">
              Detentor dos Direitos Autorais
            </span>
          </div>
          <div className="flex flex-col items-center gap-3 text-center">
            <div className="w-full h-px bg-neutral-200 dark:bg-neutral-800"></div>
            <span className="text-[9px] font-black uppercase text-neutral-900 dark:text-neutral-100 tracking-tight">
              {usage.client.name}
            </span>
