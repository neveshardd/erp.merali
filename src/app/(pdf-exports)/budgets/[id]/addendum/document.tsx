      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.grid, { marginBottom: 20 }]}>
          <View style={styles.gridCol}>
            ...
            <Text
              style={[
                styles.refText,
                { color: "#9CA3AF", fontSize: 8, marginTop: 4 },
              ]}
            >
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableHeader}>
            <Text style={[styles.colDesc, styles.headerLabel]}>
              Descrição do Novo Item
            </Text>
            <Text style={[styles.colValue, styles.headerLabel]}>
              Valor Adicional
            </Text>
          </View>
            ...
            <View key={i} style={styles.tableRow}>
              <View style={styles.colDesc}>
                ...
                <Text style={styles.itemSub}>
                  {item.type} | +{item.hours}h estimadas
                </Text>
              </View>
        ...
        <View wrap={false} style={styles.termsSection}>
          ...
          <View style={styles.termsContent}>
            ...
            <Text style={styles.termsText}>
              {data.paymentTerms}
              {"\n\n"}
              As demais cláusulas do contrato original permanecem inalteradas e
              em pleno vigor.
            </Text>
          </View>
        </View>
