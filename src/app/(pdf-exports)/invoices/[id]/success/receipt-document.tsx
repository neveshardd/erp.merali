        ...
        <View style={styles.body}>
          ...
          <View style={styles.twoCol}>
            <View style={styles.infoCard}>
              ...
              {data.payer.company ? (
                <Text style={styles.infoDetail}>{data.payer.company}</Text>
              ) : null}
              {data.payer.cnpj ? (
                <Text style={styles.infoDetail}>
                  CNPJ/CPF: {data.payer.cnpj}
                </Text>
              ) : null}
            </View>
          ...
          <View style={styles.statementBox}>
            ...
            <Text style={styles.statementText}>
              {"Recebemos de "}
              <Text style={[styles.statementBold, styles.statementUpper]}>
                {data.payer.name}
              </Text>
              {data.payer.company
                ? `, representante da empresa ${data.payer.company}, `
                : " "}
              {data.payer.cnpj
                ? `inscrita no CNPJ/CPF sob o nº ${data.payer.cnpj}, `
                : ""}
              {"a importância de "}
              <Text style={styles.statementBold}>
                {data.amountInWords.toUpperCase()}
              </Text>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <Text style={styles.tableCell}>
                Fatura #{data.invoiceId.slice(-6).toUpperCase()}
              </Text>
