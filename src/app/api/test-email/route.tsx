...
import { NewBriefingAdminEmail, BriefingReceivedClientEmail } from "@/components/emails/briefing-emails";
...
export async function GET(request: Request) {
    ...
    try {
        ...
        if (type === "payment") {
            ...
            />;
        } else if (type === "briefing_admin") {
            subject = "Novo Briefing Recebido - Merali Studio";
            react = <NewBriefingAdminEmail
                clientName="Cliente Teste"
                projectName="Casa do Lago"
            />;
        } else if (type === "briefing_client") {
