                ...
                <Card className="max-w-md w-full border-none shadow-2xl rounded-3xl overflow-hidden">
                    ...
                    <CardContent className="p-12 flex flex-col items-center text-center gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <h1 className="text-2xl font-black uppercase tracking-tighter">Briefing Enviado!</h1>
                            <p className="text-sm font-bold text-neutral-500 uppercase tracking-widest leading-relaxed">
                                Obrigado! Recebemos suas informações técnicos. Nossa equipe de produção irá analisar os dados e entraremos em contato se houver dúvidas.
                            </p>
                        </div>
                    </CardContent>
                </Card>
            ...
            <div className="bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 sticky top-0 z-50">
                <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <Image src="/logo.png" alt="Merali Logo" width={40} height={40} className="rounded-lg shadow-sm" />
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black uppercase tracking-widest text-neutral-400">Briefing Técnico</span>
                            <span className="text-xs font-black uppercase tracking-tight text-neutral-900 dark:text-white">Merali Studio</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <Card className="border-none shadow-xl bg-neutral-900 text-white rounded-3xl overflow-hidden">
                    <CardContent className="p-8 md:p-12 relative flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2 text-rose-400">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest">Informações Necessárias</span>
                        </div>
                        <div className="flex flex-col gap-2 relative z-10">
                            ...
                            <p className="text-xs md:text-sm font-bold text-white/40 uppercase tracking-[0.2em]">
                                Olá {briefing?.clientName}, preencha os detalhes técnicos para <br />iniciarmos a produção do seu projeto 3D
                            </p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                    ...
                    <section className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 px-1">
                            ...
                            <h2 className="text-[10px] font-black uppercase tracking-widest text-neutral-400">Arquivos & Formatos</h2>
                        </div>
                        <Card className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 rounded-2xl shadow-sm overflow-hidden">
                            <CardContent className="p-8 flex flex-col gap-8">
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Formato do Modelo Original</Label>
                                    <Input 
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Links para download (Drive/WeTransfer)</Label>
                                        <Button 
                                            type="button" 
                                            variant="ghost" 
                                            size="sm" 
                    ...
                    <section className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 px-1">
                            ...
                            <h2 className="text-[10px] font-black uppercase tracking-widest text-neutral-400">Atmosfera & Iluminação</h2>
                        </div>
                        <Card className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 rounded-2xl shadow-sm overflow-hidden">
                            <CardContent className="p-8 flex flex-col gap-8">
                                    ...
                                    {['Diurno', 'Crepúsculo', 'Noturno'].map((moodOption) => (
                                        ...
                                        >
                                            <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                                                mood === moodOption ? "text-rose-600 dark:text-rose-400" : "text-neutral-400 group-hover:text-black dark:group-hover:text-white"
                                            }`}>{moodOption}</span>
                                        </button>
                                    ))}
                                </div>
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Observações de Iluminação e Mood</Label>
                                    <Textarea 
                    ...
                    <section className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 px-1">
                            <Camera className="w-4 h-4 text-neutral-400" />
                            <h2 className="text-[10px] font-black uppercase tracking-widest text-neutral-400">Materiais & Destaques</h2>
                        </div>
                        <Card className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 rounded-2xl shadow-sm overflow-hidden">
                            <CardContent className="p-8 space-y-3">
                                <Label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">Materiais de Especial Atenção</Label>
                                <Textarea 
