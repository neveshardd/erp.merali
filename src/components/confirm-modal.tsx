        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent className="p-0 overflow-hidden border-none shadow-2xl rounded-3xl sm:max-w-[400px]">
                <div className={cn(
                    ...
                    variant === "danger" ? "bg-red-50 dark:bg-red-500/5" : "bg-neutral-50 dark:bg-neutral-800/50"
                )}>
                    <div className={cn(
                        "w-16 h-16 rounded-2xl flex items-center justify-center transition-transform hover:scale-110",
                        variant === "danger" ? "bg-red-100 dark:bg-red-500/10 text-red-600" : "bg-neutral-200 dark:bg-neutral-800 text-neutral-600"
                    )}>
