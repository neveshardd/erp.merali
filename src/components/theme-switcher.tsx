    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                ...
                >
                    <Sun
                        className="w-5 h-5 text-neutral-600 dark:text-neutral-400 rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0"
                    />
                    <Moon
                        className="absolute w-5 h-5 text-neutral-400 rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100"
                    />
